...
DONATE_STRING = """I don't need any donation just [support](https://t.me/movielinks_only) my group"""
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya, How can I help you? 🙂",reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="❓ Help",url="t.me/{}?start=help".format(bot.username)),InlineKeyboardButton(text=" ✉️ Public Feeds",url="https://t.me/tHe_GaMeR_B0Y")]]))
